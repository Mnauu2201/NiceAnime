...
export default function AdminDashboardClient() {
    ...
    const checkDuplicateTitle = (currentFormData) => {
        ...
        if (isDuplicate) {
            // Cập nhật thông báo lỗi cho phù hợp hơn
            setTitleError('⚠️ Tên phim chính này đã tồn tại. Vui lòng chọn tên khác.');
            return true; // Trùng
        } else {
            setTitleError('');
